...
fun_server <- function() {
  afun <-
    glue::glue(
      ...
      '    col = ggplot2::alpha(colour = \'grey80\',\n',
      '                         alpha = 0.3),\n',
      '    asp = 1\n',
      '  )\n',
      '}}\n',
      ...
      'fthighlightplot <-\n',
      '  function(plotaction,genesets,pt_size = 1,\n',
      '           meta_slice,meta,\n',
      '           input_image,\n',
      '           gene,\n',
      '           data) {{\n',
      ...
      '      meta_slice = meta_slice,pt_size = pt_size,\n',
...
page1_server <- function(df_select) {
  ...
  for (i in 1:length(df_select$slice)) {
    slice <- glue::glue(
      ...
      '  spatial_dimplot(\n',
      '    meta_slice = add_meta{i}(),,pt_size = input$point_size,\n',
      '    meta_group = meta_group_add$meta,\n',
      ...
      '  fthighlightplot(\n',
      '    plotaction = input$plotout,meta = h_meta$meta,pt_size = input$point_size,\n',
      '    meta_slice = h_meta{i}(),\n',
      '    input_image = image_slice{i}$images,\n',
      '    gene = input$gene,\n',
      ...
      '  spatial_high_select(input_image = image_slice{i}$images,meta_slice = h_meta{i}(),pt.alpha = 0.7,pt_size = input$point_size)\n',
      '}})\n',
...
page2_server <- function(df_select) {
  ...
  for (i in 1:length(df_select$slice)) {
    slice_process <- glue::glue(
      ...
      '    meta_slice = h_meta{i}(),pt_size = input$point_size,\n',
      '    input_image = image_slice{i}$images,\n',
      '    gene = input$gene_f1,\n',
      '    data = data\n',
      '  )}})\n',
...
page3_server <- function(df_select) {
  ...
  for (i in 1:length(df_select$slice)) {
    slice_process <- glue::glue(
      ...
      '  spatial_dimplot(meta_slice = add_meta{i}(),,pt_size = input$point_size,\n',
      ...
      '    spatial_dimplot(meta_slice = add_meta{i}(),meta_group = meta_group_add$meta,,pt_size = input$point_size,\n',
...
page5_server <- function(df_select) {
  ...
  for (i in 1:length(df_select$slice)) {
    slice_process <- glue::glue(
      ...
      '  spatial_dimplot(meta_slice = add_meta{i}(),\n',
      '    meta_group = meta_group_add$meta,col.by = input$subspot3,pt_size = input$point_size,\n',
      '    input_image = image_slice{i}$images)}})\n',
...
page6_server <- function(df_select) {
  ...
  for (i in 1:length(df_select$slice)) {
    slice_process <- glue::glue(
      ...
      '  coexp_feature(meta_slice = add_meta{i}(),meta_all = add_meta$meta,pt_size = input$point_size,\n',
