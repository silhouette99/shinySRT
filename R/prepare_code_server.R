...
fun_server <- function() {
  afun <- glue::glue(
    ...
    '        data_id = col.by\n',
    '      )\n',
    '    )+bg + scale_x_continuous(limits = xrange) + scale_y_continuous(limits = yrange) + theme_classic() + theme(\n',
    ...
    '      data_id = \'sampleID\'\n',
    '    )\n',
    '  ) + bg + scale_x_continuous(limits = xrange) + scale_y_continuous(limits = yrange) +\n',
    ...
    '    meta = meta[, .(nCells = .N,Means = mean(val)), by = \"sub\"]\n',
    '    meta = meta1[meta, on = \"sub\"]\n',
    '    meta = meta[, c(\"sub\", \"nCells\", \"nExpress\", \'Means\'), with = FALSE]\n',
